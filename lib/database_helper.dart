...
class DatabaseHelper {
  ...
  Future<List<FoodItem>> _retrieveFoods() async {
    ...
    for (var food in foodList){
      ...
      DateTime deleteDate = new DateTime(expiredDate.year, expiredDate.month, expiredDate.day).add(new Duration(days: 7));
      if(new DateTime(now.year, now.month, now.day).isAfter(new DateTime(expiredDate.year, expiredDate.month, expiredDate.day)) &&
          (new DateTime(now.year, now.month, now.day)) != new DateTime(expiredDate.year, expiredDate.month, expiredDate.day)) {
        food.expired = true;
