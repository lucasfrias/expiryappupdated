                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        _buildFruitCard("USE-BY & BEST BEFORE", "assets/images/apple2.png",
                            "Provided voluntary by the manufacturer to let you know how long the product will reamin at its absolute best. "
                                "The product is still edible after this date but the taste may decline.", 0xffF0BBBF),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("EXPIRES ON", "assets/images/apple2.png",
                            "Found on perishables like meat and dairy. This is a guide for stores to know how long they can display the product. "
                                "You can eat the product beyond this date as long as it is stored properly.", 0xffF0AEAF),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildFruitCard("SELL-BY", "assets/images/apple2.png",
                            "This is usually found only on baby food or other products the government regulates with regard to dating. "
                                "Do not consume past this date. ", 0xffF0AEAF),
                      ],
                    ),
                  ],
                ),
